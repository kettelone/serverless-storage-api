...
var baseHandler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var users_login, userInfo, userId, imagesList, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                users_login = event.requestContext.authorizer.claims.email;
                return [4, mysql.query("SELECT * FROM users WHERE login = \"".concat(users_login, "\""))];
            case 1:
                userInfo = _a.sent();
                return [4, userInfo[0].id];
            case 2:
                userId = _a.sent();
                return [4, mysql.query("SELECT * FROM urls WHERE email_id = ".concat(userId))];
            case 3:
                imagesList = _a.sent();
                return [2, (0, index_1.sendResponse)(200, imagesList)];
            case 4:
                error_1 = _a.sent();
                return [2, (0, index_1.sendResponse)(400, "".concat(error_1))];
            case 5: return [2];
        }
    });
}); };
